...
RUN opam pin add dockerfile.dev "git+https://github.com/mtelvers/ocaml-dockerfile.git#make-j" -y --no-action && \
    ...
    opam pin add current.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action && \
    opam pin add current_docker.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action && \
    opam pin add current_git.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action && \
    opam pin add current_github.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action && \
    opam pin add current_rpc.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action && \
    opam pin add current_slack.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action && \
    opam pin add current_web.dev "git+https://github.com/mtelvers/ocurrent.git#extend-rpc" -y --no-action
